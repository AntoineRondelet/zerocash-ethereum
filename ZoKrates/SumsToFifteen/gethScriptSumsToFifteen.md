...
3. Compile the contract to get the ABI: echo "var sumsToFifteenOutput=`solc --optimize --combined-json abi,bin,interface contracts/SumsToFifteenDebug.sol`" > sumsToFifteen.js
4. In geth:
```bash
loadScript('sumsToFifteen.js')
var sumsToFifteenABI = sumsToFifteenOutput.contracts['contracts/SumsToFifteenDebug.sol:SumsToFifteenDebug'].abi
var sumsToFifteenAddress = "0x1ee9384c3a163728b8a91de48575fb1b814806c8";
